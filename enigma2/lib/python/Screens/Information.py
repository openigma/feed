...
commitLogs = [
	("Enigma2", API_GITHUB, f"https://api.github.com/repos/openpli/enigma2/commits{branch}"),
	("Openpli Oe Core", API_GITHUB, f"https://api.github.com/repos/openpli/openpli-oe-core/commits{branch}"),
	...
	("Plugin EPGImport", API_GITHUB, "https://api.github.com/repos/openpli/enigma2-plugin-extensions-epgimport/commits"),
	("Skin PLi HD", API_GITHUB, "https://api.github.com/repos/littlesat/skin-PLiHD/commits"),
